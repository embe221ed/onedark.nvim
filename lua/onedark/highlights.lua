...
if vim.api.nvim_call_function("has", { "nvim-0.8" }) == 1 then
    hl.treesitter = {
        ...
        ["@markup.italic"] = { fg = c.none, fmt = "italic" },
        ["@markup.strong"] = {fg = c.none, fmt = 'bold'},
        ["@markup.strike"] = {fg = c.fg, fmt = 'strikethrough'},
        ["@markup.underline"] = {fg = c.fg, fmt = 'underline'},
        ["@module"] = {fg = c.yellow, fmt = 'italic'},
        ["@none"] = colors.Fg,
        ["@number"] = colors.Orange,
        ["@number.float"] = colors.Orange,
        ["@operator"] = colors.Fg,
        ["@parameter.reference"] = {fg = c.fg, fmt = 'italic'},
        ["@parameter.readonly"] = {fg = c.fg, fmt = 'italic'},
        ["@parameter.modification"] = {fg = c.fg, fmt = 'italic'},
        ...
        ["@namespace"] = {fg = c.yellow, fmt = 'italic'},
